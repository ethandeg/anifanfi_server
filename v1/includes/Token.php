<?php 
class Token {
    static public function createToken($payload, $secret = 'sekWDashoSalt') {
    ...
    private static function is_jwt_valid($jwt, $secret = 'sekWDashoSalt') {
        // split the jwt
    ...
    static public function decodeToken($token){
        return json_decode(self::is_jwt_valid($token),true);
    }
